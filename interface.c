...
create_window_urgence (void)
{
  ...
  GtkWidget *textview_cas_urgence;
  ...
  textview_cas_urgence = gtk_text_view_new ();
  gtk_widget_show (textview_cas_urgence);
  gtk_fixed_put (GTK_FIXED (fixed6), textview_cas_urgence, 232, 192);
  gtk_widget_set_size_request (textview_cas_urgence, 128, 104);
  ...
  GLADE_HOOKUP_OBJECT (window_urgence, textview_cas_urgence, "textview_cas_urgence");
